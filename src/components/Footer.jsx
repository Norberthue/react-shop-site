...
export default function Footer() {
  return (
    <footer className='flex flex-col py-4 sm:py-0 sm:flex-row px-20  bg-black xl:w-screen max-w-[1900px] xl:h-[210px] text-white items-center justify-between gap-4 md:gap-8'>
